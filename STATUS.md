...
- [x] **Agent empty-conversation state floats in dead space** (2026-06-27) — changed `.agent-starters` `justify-content: center` → `flex-start` and bumped top padding to 16px; starters now anchor below the briefing card rather than floating in the void. `styles.css` only.
